...
# include <math.h>
#include <string.h>
double minima_exhaustive_search();
...
double minima_exhaustive_search(double a,double b)
{
	int n,i,fun_ev;
	...
	while(x3<b);
	printf("\nThe minima lies between (%lf %lf)\n",x1,x3);
	printf("\nTotal no of function evaluation is %d\n",fun_ev);
	printf("\nTotal no of iteration is %d\n",i);
	fprintf(fptr,"\nThe minima lies between (%lf,%lf)",x1,x3);
