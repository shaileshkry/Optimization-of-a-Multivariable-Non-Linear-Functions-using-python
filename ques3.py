...
def fun(Variable):
    ...
    for i in range(1, len(Variable)):
        result = result + ((i+1)*((2*(Variable[i]**2)- Variable[i-1])**2))
        result = result + ((Variable[0] - 1)**2)
    return result
...
Variable = np.random.uniform(-10, 10, size = (input[0]))
print("**************************************************************")
print(" Dixon-Price Function ")
print("**************************************************************")
print('**************************************************************',file=file2)
print(' Dixon-Price Function ',file=file2)
print('**************************************************************',file=file2)
