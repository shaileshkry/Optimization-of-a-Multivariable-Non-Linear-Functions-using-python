...
def fun(Variable):
    ...
    for i in range(1, (len(Variable) +1)):
        result1 = result1 + ((Variable[i-1] - 1)**2)
    for i in range(1, len(Variable)):
        result2 = result2 + (Variable[i]*Variable[i-1])
...
Variable = np.random.uniform(-(input_variables[0]**2), (input_variables[0]**2), size = (input[0]))
print("**************************************************************")
print(" Trid Function ")
print("**************************************************************")
print('**************************************************************',file=file2)
print('Trid Function ',file=file2)
print('**************************************************************',file=file2)
